		...
		<form name="newWrite" action="./BoardWriteAction.do"
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10 ">
				 <input type="submit" class="btn btn-primary " style="background-color:#f34336" value="REGISTER ">				
					 <input type="reset" class="btn btn-primary " style="background-color:#f34336" value="CANCEL ">
				</div>
			</div>
		</form>
		<hr>
